...
DATASET_SUBSET_PERCENT = 100   # 100% del dataset para modelo 10m - suficiente para entrenamiento
...
BATCH_SIZE = 80        # Reducir para CPU y dataset pequeño
...
OUTPUT_DIR = os.path.join(OUTPUT_BASE, "HRM-Micro-10M-standalone-v1.0-output")
...
if not os.environ.get('HRM_IMPORT_ONLY'):
    ...
    tokenizer = AdaptiveBPETokenizer(vocab_size=5000)  # Vocabulario de 5K tokens
