...
class HRMText1Config(ConfigBase):
    ...
    def __init__(self,
                 ...
                 block_size=1024,           # Medium model context - incrementado considerablemente
                 n_embd=768,                # Medium model embeddings - escalado apropiadamente
                 n_head=12,                 # Medium model heads - múltiplo de n_embd
                 n_layers=12,               # Medium model layers - balance entre capacidad y estabilidad
...
def train_hrm_hf(
    ...
    # Para entrenamientos grandes (100M+), usar warmup más largo
    if len(train_texts) >= 10000:  # Si >= 10K samples
        effective_warmup_steps = max(warmup_steps, total_steps // 15)  # ~6.7% warmup
        print(f"🔥 Modelo Medium 100M: Warmup extendido a {effective_warmup_steps} steps")
    else:
    ...
    print(f"🎯 Entrenamiento Medium 100M configurado:")
    ...
    print(f"\n🎉 ¡Iniciando entrenamiento Medium 100M!")
    print("=" * 60)
    ...
    print(f"\n✅ ¡Entrenamiento Medium 100M completado!")
...
def main():
    ...
    if len(os.sys.argv) == 1:
        ...
        print("  python hrm_training_medium_100m_standalone_hf.py --no_streaming --train_samples 50000")
        print("  ")
