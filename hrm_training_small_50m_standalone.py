...
DATASET_SUBSET_PERCENT = 5.0   # Usar más datos para modelo pequeño (más eficiente)
...
BATCH_SIZE = 16           # Optimizado para single-GPU con mejor throughput (6x más eficiente que batch=1)
