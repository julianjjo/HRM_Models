...
VERSIÓN MEDIUM: Configuración para ~350M parámetros con contexto intermedio (1024 tokens)
...
OUTPUT_DIR = os.path.join(OUTPUT_BASE, "hrm_models_c4_medium_350m_output")
