...
def train_hrm_hf(
    ...
    """Entrenar modelo HRM Small 50M con tokenizador HuggingFace"""
    ...
    print(f"🚀 Iniciando entrenamiento HRM Small 50M con tokenizador HF")
    print(f"📊 Configuración:")
    ...
    # Para entrenamientos grandes (50M+), usar warmup más largo
    if len(train_texts) >= 10000:  # Si >= 10K samples
        effective_warmup_steps = max(warmup_steps, total_steps // 15)  # ~6.7% warmup
        print(f"🔥 Modelo Small 50M: Warmup extendido a {effective_warmup_steps} steps")
    else:
    ...
    print(f"🎯 Entrenamiento Small 50M configurado:")
    ...
    print(f"\n🎉 ¡Iniciando entrenamiento Small 50M!")
    print("=" * 60)
    ...
    print(f"\n✅ ¡Entrenamiento Small 50M completado!")
...
def main():
    parser = argparse.ArgumentParser(description="Entrenar HRM Small 50M con tokenizador HuggingFace optimizado")
    ...
    if len(os.sys.argv) == 1:
        print("🚀 HRM Small 50M Training con Tokenizador HuggingFace")
        print("\nUso:")
        print("  python hrm_training_small_50m_standalone_hf.py [opciones]")
        print("\nEjemplos:")
        print("  # Entrenar con GPT2 inglés (configuración automática)")
        print("  python hrm_training_small_50m_standalone_hf.py --tokenizer openai-community/gpt2")
        print("  ")
        print("  # NO STREAMING (descarga completa, recomendado para entrenamientos grandes)")
        print("  python hrm_training_small_50m_standalone_hf.py --no_streaming --train_samples 50000")
        print("  ")
        print("  # Modo CPU INTENSIVO")
        print("  python hrm_training_small_50m_standalone_hf.py --cpu_intensive --batch_size_multiplier 2")
        print("  ")
        print("  # Configuración manual de workers + no streaming")
        print("  python hrm_training_small_50m_standalone_hf.py --num_workers 8 --no_streaming")
        print("  ")
        print("  # Dataset diferente en español")
        print("  python hrm_training_small_50m_standalone_hf.py --tokenizer DeepESP/gpt2-spanish --no_streaming")
        return
