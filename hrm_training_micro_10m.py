...
DATASET_SUBSET_PERCENT = 30.0   # Usar más datos para modelo pequeño (más eficiente)
...
BATCH_SIZE = 260        # Batch masivo para aprovechar VRAM de H200 (~13GB uso estimado)
