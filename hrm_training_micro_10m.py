...
def get_dataloader_workers():
    ...
    if is_distributed and world_size > 1:
        ...
        optimal_workers = min(64, max(32, mp.cpu_count() // world_size))
...
if is_multi_gpu and safe_num_workers > 0:
    ...
    prefetch_factor = max(262144, safe_num_workers * 1024)  # Optimizado para AMD EPYC 7443 24-Core con 480GB RAM
